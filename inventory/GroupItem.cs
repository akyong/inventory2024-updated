...
namespace inventory
{
    public partial class GroupItem : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (button1.Text == "SAVE")
            {
                ...
                else
                {
                    ...
                    string queryCheck = "SELECT * FROM GROUP_ITEM WHERE code=@codec and delete_flag='N'";
                    ...
                    else
                    {
                        try
                        {
                            string query = "INSERT INTO GROUP_ITEM( code,name,description,delete_flag ) VALUES( @code,@names,@description,'N' )";
                        ...
                        string query2 = "select top 1 * from GROUP_ITEM where delete_flag='N' ORDER BY ID DESC ";
        ...
        private void refreshList(string nilaiyangdicari)//this one
        {
            ...
            string query = "SELECT * FROM GROUP_ITEM WHERE delete_flag='N'";
                ...
                else
                {
                    ...
                    if (reader.Read())
                    {
                        ...
                        if (id == idgudang.Text)
                        {
                            ...
                            string query = "UPDATE GROUP_ITEM SET code=@code, name=@name,description=@description WHERE id=@id";
                            Connection.command = new OleDbCommand(query, Connection.conn);
                            Connection.command.CommandType = CommandType.Text;
                            Connection.command.Parameters.AddWithValue("@code", codeTxt.Text);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                Connection.ConnectionClose();
                Connection.ConnectionOpen();
                string queryCheck = "DELETE FROM GROUP_ITEM WHERE id=@id";
                Connection.command = new OleDbCommand(queryCheck, Connection.conn);
                Connection.command.CommandType = CommandType.Text;
                Connection.command.Parameters.AddWithValue("@id", idgudang.Text);
        ...
        private void findBtn_Click(object sender, EventArgs e)
        {
            ...
            int promptValue = SearchGroupItem.ShowDialog("Cari Kelompok Barang", fieldTable);
