...
namespace inventory
{
    public partial class Pajak : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (button1.Text == "ADD")
            {
                ...
                persentaseTxt.Enabled = true;
                descriptionTxt.Enabled = true;

                codeTxt.Text = "";
                nameTxt.Text = "";
                persentaseTxt.Text = "0";
                descriptionTxt.Text = "";
            ...
            else if (button1.Text == "SAVE")
            {
                ...
                else
                {
                    ...
                    string queryCheck = "SELECT * FROM PAJAK WHERE code=@codec and delete_flag='N'";
                    ...
                    if (reader.Read())
                    {
                        ...
                        DialogResult avaiable = MessageBox.Show("Kode Pajak " + codeTxt.Text + " sudah ada", "Duplicate", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    ...
                    else
                    {
                        try
                        {
                            string query = "INSERT INTO PAJAK( code,name,persentase, description,delete_flag ) VALUES( @code,@names,@persentase,@description,'N' )";
                            ...
                            Connection.command.Parameters.AddWithValue("@persentase", persentaseTxt.Text);
                        ...
                        string query2 = "select top 1 * from PAJAK where delete_flag='N' ORDER BY ID DESC ";
            ...
            else if (button2.Text == "UPDATE")
            {
                ...
                else
                {
                    ...
                    if (reader.Read())
                    {
                        ...
                        if (id == idgudang.Text)
                        {
                            string query = "UPDATE PAJAK SET code=@code, name=@name, persentase=@persentase, description=@description WHERE id=@id";
                            Connection.command = new OleDbCommand(query, Connection.conn);
                            Connection.command.CommandType = CommandType.Text;
                            Connection.command.Parameters.AddWithValue("@code", codeTxt.Text);
                        ...
                        {
                            DialogResult avaiable = MessageBox.Show("Kode Pajak " + codeTxt.Text + " sudah terpakai", "Duplicate", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            if (avaiable == DialogResult.Yes)
                            {
                                this.Close();
                            }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                Connection.ConnectionClose();
                Connection.ConnectionOpen();
                string queryCheck = "DELETE FROM PAJAK WHERE id=@id";
                Connection.command = new OleDbCommand(queryCheck, Connection.conn);
                Connection.command.CommandType = CommandType.Text;
                Connection.command.Parameters.AddWithValue("@id", idgudang.Text);
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (cell != null)
            {
                ...
                persentaseTxt.Text = row.Cells["persentase"].Value.ToString();
        ...
        private void refreshList(string nilaiyangdicari)//this one
        {
            ...
            string query = "SELECT * FROM PAJAK WHERE delete_flag='N'";
        ...
        private void findBtn_Click(object sender, EventArgs e)
        {
            ...
            fieldTable.Add("name", "Nama Pajak");
            fieldTable.Add("code", "Kode Pajak");

            int promptValue = SearchTax.ShowDialog("Cari Pajak", fieldTable);
