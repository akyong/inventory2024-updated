...
{
    public partial class ReportViewerDeliveryOrder : Form
    {
        string iddeliveryorder;
        public ReportViewerDeliveryOrder(string deliveryorder)
        {
            iddeliveryorder = deliveryorder;
            InitializeComponent();
        }

        private void ReportViewerDeliveryOrder_Load(object sender, EventArgs e)
        {
            ...
            reportDoc.SetParameterValue("deliveryorderid", iddeliveryorder);
