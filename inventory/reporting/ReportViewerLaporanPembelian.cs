...
{
    public partial class ReportViewerLaporanPembelian : Form
    {
        public static DateTime datefrom;
        public static DateTime dateto;
        public static string setatus;
        public ReportViewerLaporanPembelian(string from, string to, string status)
        {
            from = from + " 00:00:00";
            to = to + " 23:59:59";
            setatus = status;
        ...
        private void ReportViewerLaporanPembelian_Load(object sender, EventArgs e)
        {
            ...
            string filePath = Application.StartupPath + "/reporting/LaporanPembelian.rpt";
