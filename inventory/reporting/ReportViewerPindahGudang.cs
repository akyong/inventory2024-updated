...
{
    public partial class ReportViewerPindahGudang : Form
    {
        string pindahgudang;
        public ReportViewerPindahGudang(string idpindahgudang)
        {
            pindahgudang = idpindahgudang;
            InitializeComponent();
        }

        private void ReportViewerPindahGudang_Load(object sender, EventArgs e)
        {
            ...
            string filePath = Application.StartupPath + "/reporting/BuktiPindahGudang.rpt";
            ...
            reportDoc.SetParameterValue("pindahgudangid", pindahgudang);
