...
{
    public partial class ReportViewerReceivedItem : Form
    {
        string idreceiveditem;
        public ReportViewerReceivedItem(string receiveditemid)
        {
            idreceiveditem = receiveditemid;
            InitializeComponent();
        }

        private void ReportViewerReceivedItem_Load(object sender, EventArgs e)
        {
            ...
            reportDoc.SetParameterValue("idreceived", idreceiveditem);
