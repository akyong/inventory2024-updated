...
{
    public static class SearchSupplier
    {
        public static int ShowDialog(string Judul, Hashtable fieldTable)
        {
            int liSize = fieldTable.Count;
            string tablename = "SUPPLIER SP LEFT JOIN GROUP_SUPPLIER GS ON GS.ID = SP.GROUP_SUPPLIER_ID";
            string fieldname = "SP.ID, SP.CODE, SP.NAME, SP.ADDRESS, SP.PLAFON, SP.PLAFON_FLAG, GS.NAME AS GROUPSUPPLIER,GS.ID AS GROUPSUPPLIERID";
            ...
            coloumName.DataPropertyName = "name";
            coloumName.HeaderText = "Nama";
            coloumName.Width = 80;

            DataGridViewTextBoxColumn coloumGroupCustomer = new DataGridViewTextBoxColumn();
            coloumGroupCustomer.DataPropertyName = "groupcustomer";
            coloumGroupCustomer.HeaderText = "Kelompok";
            coloumGroupCustomer.Width = 80;

            DataGridViewTextBoxColumn coloumplafon = new DataGridViewTextBoxColumn();
            coloumplafon.DefaultCellStyle.Format = "N";
            coloumplafon.DataPropertyName = "plafon";
            coloumplafon.HeaderText = "Plafon";
            coloumplafon.Width = 80;

            DataGridViewCheckBoxColumn coloumplafonFlag = new DataGridViewCheckBoxColumn();
            coloumplafonFlag.DataPropertyName = "plafon_flag";
            coloumplafonFlag.HeaderText = "Flag";
            coloumplafonFlag.TrueValue = "1";
            coloumplafonFlag.FalseValue = "0";
            coloumplafonFlag.Width = 80;

            DataGridViewTextBoxColumn coloumAddress = new DataGridViewTextBoxColumn();
            coloumAddress.DataPropertyName = "address";
            coloumAddress.HeaderText = "Alamat";
            coloumAddress.Width = 150;
            ...
            dataGridView2.Columns.Add(coloumGroupCustomer);
            dataGridView2.Columns.Add(coloumplafon);
            dataGridView2.Columns.Add(coloumplafonFlag);
            dataGridView2.Columns.Add(coloumAddress);
            ...
            while (list.Read())
            {
                dataGridView2.Rows.Add(list["ID"], list["Code"], list["Name"], list["groupsupplier"], list["plafon"], list["plafon_flag"], list["address"]);
            }
            ...
            searchTextTxt.TextChanged += (s, e) =>
            {
                ...
                {
                    dataGridView2.Rows.Add(autocomplete["ID"], autocomplete["Code"], autocomplete["Name"], autocomplete["groupsupplier"], autocomplete["plafon"], autocomplete["plafon_flag"], autocomplete["address"]);
                }
            };
