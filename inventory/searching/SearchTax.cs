...
namespace inventory.searching
{
    public static class SearchTax
    {
        public static int ShowDialog(string Judul, Hashtable fieldTable)
        {
            ...
            string fieldname = "ID,Code,Name,Persentase,Description";
            ...
            DataGridViewTextBoxColumn coloumPersen = new DataGridViewTextBoxColumn();
            coloumPersen.DataPropertyName = "persentase";
            coloumPersen.HeaderText = "%";
            coloumPersen.Width = 30;
            ...
            dataGridView2.Columns.Add(coloumPersen);
            ...
            while (list.Read())
            {
                dataGridView2.Rows.Add(list["ID"], list["Code"], list["Name"], list["Persentase"], list["Description"]);
            }
            ...
            searchTextTxt.TextChanged += (s, e) =>
            {
                ...
                {
                    dataGridView2.Rows.Add(autocomplete["ID"], autocomplete["Code"], autocomplete["Name"], autocomplete["Persentase"], autocomplete["Description"]);
                }
            };
