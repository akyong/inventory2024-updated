...
{
     public static class SearchWarehouse
    {
        public static int ShowDialog(string Judul, Hashtable fieldTable)
        {
            ...
            string fieldname = "ID,Code,Name,Address,Description";
            ...
            while (list.Read())
            {
                dataGridView2.Rows.Add(list["ID"], list["Code"], list["Name"], list["Address"], list["Description"]);
            }
            ...
            searchTextTxt.TextChanged += (s, e) =>
            {
                ...
                {
                    dataGridView2.Rows.Add(autocomplete["ID"], autocomplete["Code"], autocomplete["Name"], autocomplete["Address"], autocomplete["Description"]);
                }
            };
